...
class TicketsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_tickets_activities1_idx' => ['type' => 'index', 'columns' => ['activity_id'], 'length' => []],
            'fk_tickets_users1_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => 1529983475,
                'updated_at' => 1529983475
            ],
        ];
        parent::init();
    }
