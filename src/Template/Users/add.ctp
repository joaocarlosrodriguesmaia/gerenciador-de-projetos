      ...
      <fieldset>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
              <?php
                  echo $this->Form->control('password', ['label' => 'Senha', 'class' => 'form-control', 'required' => 'true']);
              ?>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
              <?php
                  echo $this->Form->control('password_confirmation', ['label' => 'Confirmar Senha', 'type' => 'password', 'class' => 'form-control', 'required' => 'true']);
              ?>
              </div>
            </div>
          </div>
